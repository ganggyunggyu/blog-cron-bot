...
- 노출 키워드 수: 21개
- 확인 실패 키워드 수: 0개
- 결과 CSV: /Users/ganggyunggyu/Programing/blog-cron-bot/output/2026-03월3주차/cafe-exposure-check/cafe-exposure-check_2026-03-18-10-09-01.csv

## 카페명 체크 검토
- 쇼핑지름신: 이름 매칭 15건, ID 매칭 0건, 확인된 카페명 쇼핑지름신 (구매대행, 공동구매, 해외직구, 체험단, 핫딜), 확인된 sourceId shopjirmsin
- 샤넬오픈런: 이름 매칭 9건, ID 매칭 0건, 확인된 카페명 샤넬오픈런 - No. 1 명품 대표 커뮤니티, 확인된 sourceId shoppingtpw
